tasks(); //mostrar todoas las tareas
                   ...
                   document.querySelector("#addTask").addEventListener('submit', function (e) {
                       ...
                       var url = 'http://localhost/labo11/task/api/createTask.php'; //URL del api a consumir
                       var data = {
                   ...
                   document.querySelector("#updateTask").addEventListener('submit', function (e) {
                       e.preventDefault();
                       var url = 'http://localhost/labo11/task/api/updateTask.php';
                       var data = {
                   ...
                   function tasks() {
                       ...
                       let infoTask = "";
                       fetch('http://localhost/labo11/task/api/tasks.php')
                           .then(function (response) {
                               ...
                               JSON.parse(data).forEach(element => {
                                   infoTask = infoTask + `<tr>
                                       ...
                                       <td>
                                           <a href="http://localhost/labo11/task/api/task.php/${element.id}" class="update btn btn-primary btn-sm update" data-toggle="modal" data-target="#update">Actualizar</a>
                                           <a href="http://localhost/labo11/task/api/deleteTask.php/${element.id}" class="delete btn btn-danger btn-sm">Eliminar</a>
                                       </td>
                                   </tr>`;
                               });
